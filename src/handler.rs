...
impl Handler{
    ...
    async fn do_handle_request<R:ResponseHandler>(&self,request: &Request,response : R)-> Result<ResponseInfo,Error>{
    ...
    async fn do_handle_request_myip<R:ResponseHandler>(&self,request: &Request,mut responder : R) -> Result<ResponseInfo,Error>{
    ...
    async fn do_handle_request_counter<R: ResponseHandler>(&self,request : &Request,mut responder : R)-> Result<ResponseInfo,Error>{
...
impl RequestHandler for Handler{
    async fn handle_request<R:ResponseHandler>(&self,_request :&Request,_response: R)->ResponseInfo{
